...
if __name__ == '__main__':
    ...
    img_dir = "./finetune.movenet/data/train"
    labels_path = "./finetune.movenet/data/annotations/person_keypoints_train.json"
    output_name = './finetune.movenet/data/cropped/train.json'
    main(img_dir, labels_path, output_name, output_img_dir)
