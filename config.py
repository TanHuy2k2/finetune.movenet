...
cfg = {
    ...
    ##### Train Setting
    'img_path':"./finetune.movenet/data/cropped/imgs",
    'train_label_path':'./finetune.movenet/data/cropped/train.json',
    'val_label_path':'./finetune.movenet/data/cropped/val.json',
    'balance_data':False,
    ...
    ##### Test
    'test_img_path':"./finetune.movenet/data/cropped/imgs",
